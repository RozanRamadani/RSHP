...
<?php
session_start();
if (!isset($_SESSION['user']) || !isset($_SESSION['user']['role_aktif']) || $_SESSION['user']['role_aktif'] != '3') {
    ...
    <div class="dashboard-container">
        <div class="dashboard-header">
            ...
            <div>
                ...
                <div class="admin-info">Halo, <b><?php echo htmlspecialchars($_SESSION['user']['nama'] ?? ''); ?></b> &mdash; Anda login sebagai <b>Perawat</b>.</div>
            </div>
        </div>
